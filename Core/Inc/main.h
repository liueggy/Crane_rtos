...
#define DC_M1_IN1_Pin GPIO_PIN_0
#define DC_M1_IN1_GPIO_Port GPIOC
#define DC_M1_IN2_Pin GPIO_PIN_1
#define DC_M1_IN2_GPIO_Port GPIOC
#define DC_M2_IN1_Pin GPIO_PIN_2
#define DC_M2_IN1_GPIO_Port GPIOC
#define DC_M2_IN2_Pin GPIO_PIN_3
...
#define DC_M1_PWM_Pin GPIO_PIN_6
#define DC_M1_PWM_GPIO_Port GPIOA
#define DC_M2_PWM_Pin GPIO_PIN_7
#define DC_M2_PWM_GPIO_Port GPIOA
#define DC_M3_IN1_Pin GPIO_PIN_4
#define DC_M3_IN1_GPIO_Port GPIOC
#define DC_M3_IN2_Pin GPIO_PIN_5
#define DC_M3_IN2_GPIO_Port GPIOC
#define DC_M3_PWM_Pin GPIO_PIN_0
#define DC_M3_PWM_GPIO_Port GPIOB
#define DC_M4_PWM_Pin GPIO_PIN_1
#define DC_M4_PWM_GPIO_Port GPIOB
...
#define DC_M4_IN2_Pin GPIO_PIN_6
#define DC_M4_IN2_GPIO_Port GPIOC
#define DC_M4_IN1_Pin GPIO_PIN_7
#define DC_M4_IN1_GPIO_Port GPIOC
